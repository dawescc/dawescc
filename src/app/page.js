	...
	return (
		<main className='text-zinc-200 bg-zinc-900 break-words'>
			<div className='flex min-h-screen flex-col px-12 py-20'>
              ...
              <div class="h-20 w-auto rounded-xl overflow-hidden border border-zinc-700 shadow-md
                          absolute top-0 left-0 -translate-x-12 -translate-y-12">
                <img class="object-cover w-full h-full" src="https://neutgwolrftsfsvfhutp.supabase.co/storage/v1/object/public/blog/16bmtkif9g3i.png" />
              </div>
